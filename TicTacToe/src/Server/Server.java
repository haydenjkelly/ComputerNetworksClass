...
public class Server {
	...
	protected final static Map<Integer,ClientEndPoint> clientEndPoints = Collections.synchronizedMap(new HashMap<Integer,ClientEndPoint>());
	...
	protected final static Map<String,Set<ClientEndPoint>> groups =  Collections.synchronizedMap(new HashMap<String,Set<ClientEndPoint>>());
